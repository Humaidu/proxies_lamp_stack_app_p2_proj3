...
retry 5 sudo yum update -y
retry 5 sudo yum install -y amazon-cloudwatch-agent
        ...
        "collect_list": [
          {
            ...
            "log_group_name": "/${project_name}/apache-access",
            "log_stream_name": "{instance_id}"
          },
          {
            "file_path": "/var/log/httpd/error_log",
            "log_group_name": "/${project_name}/apache-error",
            "log_stream_name": "{instance_id}"
          },
          {
            "file_path": "/var/log/messages",
            "log_group_name": "/${project_name}/system-messages",
            "log_stream_name": "{instance_id}"
          }
        ]
      }
